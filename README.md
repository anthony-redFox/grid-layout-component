...
It is fork of [React-Grid-Layout](https://react-grid-layout.github.io/react-grid-layout/) and was reworked on web compoenent React-Grid-Layout is a grid layout system much like [Packery](http://packery.metafizzy.co/) or
